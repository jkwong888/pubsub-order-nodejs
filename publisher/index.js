...
async function main() {
  ...
  async function publishOrderedMessage(data) {
  ...
  while (true) { //count < 1000) {
    var message = {
        ...
        messageNum: String(Date.now()),
    };
    var messageId = publishOrderedMessage(JSON.stringify(message));
    console.log("Published message " + messageId + ", contents = " + JSON.stringify(message));
    count = count + 1;
